  ...
  return (
    <div className={styles.home}>
      <Meta
        ...
        description="portfolio of Adarsh V S — a product designer working on web & mobile
      ...
      <ProjectSummary
        ...
        index={1}
        title="VideoIDE"
        description="An interactive educational platform for students"
        ...
        model={{
          ...
          textures: [
            {
              srcSet: [videoIdeDark, videoIdeDarkLarge],
              placeholder: videoIdeDarkPlaceholder,
            },
          ],
        }}
      />
